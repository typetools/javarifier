...
//         if (jrType == null) {
//             SootClass enclosingClass = getDeclaringClass();
//             SignatureTag sTag = (SignatureTag) getTag("SignatureTag");
//             if (sTag == null) {
//                 jrType = JVMLSigParser.parseJrType(AbstractJasminClass.jasminDescriptorOf(getType()), enclosingClass);
//             } else {
//                 jrType = JVMLSigParser.parseJrType(sTag.getSignature(), enclosingClass);
//             }
//         }
        return jrType;
    }
