...
public class Scene  //extends AbstractHost
{
    ...
    {
      // TODO: why wasn't this failing before?
      
      if(className.contains("Map$Entry")) {
        ...
        // TODO: see above
//        if(true) {
//        SootClass pc = new SootClass(className, 0);
//        pc.setResolvingLevel(0);
//        pc.setPhantom(true);
//        addClass(pc);
//        return pc;
//        }
	  ...
	  // TODO:
	  //System.err.println("Error: Scene.getClass() returning null for: " + className);
	  return null;
